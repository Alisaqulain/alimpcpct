...
export async function GET(req) {
  try {
    ...
    console.log(`Found ${sections.length} sections and ${questions.length} questions for exam ${examId}`);
    sections.forEach(s => {
    ...
    questions.forEach(q => {
      ...
      console.log(`Question: ${q.question_en?.substring(0, 30)}... (sectionId: ${q.sectionId}, examId: ${q.examId}, imageUrl: ${q.imageUrl || 'none'})`);
    });
